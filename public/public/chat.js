...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // =============================================
    // GENERAR RESPUESTAS DE IA CON GEMINI REAL
    // =============================================
    async function getAIResponse(message, mode) {
        const API_KEY = 'AIzaSyAiiD6Q6P8O9gaUrR21-oBlPpuOCCi6C-c';
        ...
        try {
            const response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=' + API_KEY, {
                ...
                body: JSON.stringify({
                    contents: [{
                        parts: [{
                            text: `Eres Dominius AI, un asistente especializado para empresarios y empresas. 
                            Modo actual: ${mode}
                            Contexto: Eres experto en negocios, estrategia, finanzas y análisis de mercado.
                            Responde como un consultor empresarial profesional.
            ...
            if (data.candidates && data.candidates[0] && data.candidates[0].content && data.candidates[0].content.parts[0]) {
                ...
                Como asistente empresarial, te recomiendo: 
                1. Analizar detalladamente tu situación actual
            ...
            Mientras se restablece, te sugiero:
            • Revisar tu modelo de negocio actual
    ...
    console.log('✅ Chat cargado correctamente con Gemini AI');
});